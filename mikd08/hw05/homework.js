window.addEventListener("DOMContentLoaded", () => {
    ...
    const calculatePepeAge = (birthYear) => {
        const currentYear = new Date().getFullYear();
        console.log(`Pepe is ${currentYear - birthYear} years old.`);
    };
    ...
    buttonPepeAge.addEventListener('click', () => calculatePepeAge(1990));
    ...
    const calculateCircleArea = (radius) => {
        ...
        document.getElementById('results').innerText = `The area of the circle with radius ${radius} is ${area.toFixed(2)} square units.`;
    };
    ...
    const calculateConeVolume = (radius, height) => {
        ...
        document.getElementById('results').innerText = `The volume of the cone with radius ${radius} and height ${height} is ${volume.toFixed(2)} cubic units.`;
    };
    ...
    const isTriangle = (a, b, c) => {
        ...
        document.getElementById('results').innerText = `Sides ${a}, ${b}, ${c} can${isValid ? '' : 'not'} form a triangle.`;
        return isValid;
    };
    
    // Button for Triangle Validation
    const buttonTriangle = document.createElement('button');
    buttonTriangle.innerText = 'Check if Triangle';
    buttonTriangle.addEventListener('click', () => isTriangle(7, 10, 5));
    ...
    const calculateTriangleArea = (a, b, c) => {
        ...
        if (!isTriangle(a, b, c)) {
            resultsDiv.innerText = `Invalid sides: ${a}, ${b}, ${c} cannot form a triangle.`;
            return;
        }
        ...
        resultsDiv.innerText = `The area of the triangle with sides ${a}, ${b}, ${c} is ${area.toFixed(2)} square units.`;
    };
    ...
    buttonTriangleArea.addEventListener('click', () => calculateTriangleArea(7, 10, 5));
