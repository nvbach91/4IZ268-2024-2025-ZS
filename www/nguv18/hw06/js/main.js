...
document.querySelector(".submit").addEventListener("click", function (e) {
    ...
    const encryptedText = document.getElementById("fname").value;
    const key = parseInt(document.getElementById("lname").value);

    if (!encryptedText || isNaN(key)) {
        alert("Please enter valid encrypted text and a number for the key.");
        return;
    }

    
    const decryptedText = caesarDecipher(encryptedText, key);
