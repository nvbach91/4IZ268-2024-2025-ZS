...
const shiftChar = (c, shift) => {
    ...
    const shiftedIndex = (originalIndex - shift + 26) % 26; 
    return alphabet.charAt(shiftedIndex);
};


const shiftString = (str, shift) => {let result = '';
...
document.getElementById("input").addEventListener("submit", function (e) {
    ...
    const shiftValue = parseInt(document.getElementById("decipher").value);

   
    const decipheredText = caesarDecipher(cipherText, shiftValue);

    
    document.getElementById("results").innerText = decipheredText;
});
